...
def xlm_specific_setup(encoder, ancestor_model: transformers.XLMModel, model_config_path: str):
    ...
    # (Transformers actually does provide a `lang_id` default, but it's set to an arbitrary
    # value and isn't consistently used. Here, we force the user to set it to a desired value
    # if necessary.)
